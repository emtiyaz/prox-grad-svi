...
algos = {'infKL_sKL','infKL_sKL','infKL_sKL','infKL_sKL','infKL_sKL','infKL_sKL','infKL_sKL','infKL_sKL','infKL_sKL','infKL_sKL','infKL_sKL','infKL_sKL','infKL_sKL','infKL_sKL','infKL_sKL','infKL_sKL','infKL_sKL','infKL_sKL','infKL_sKL'};
...
for i=1:length(algos) 
	...
	res_name=sprintf('./%s/%s.data.plot-gd-chol-%d.mat',output_path,dataset_name,i);

...
for i=1:length(algos) 
	...
	case 1
		...
		case 'sonar'
			...
			hyp.sample_size=2000; 
			hyp.decay_factor=1.0-(1e-9)/2;
		case 'ionosphere'
			hyp.learning_rate=0.1;
			hyp.mini_batch_size=5;
			hyp.sample_size=500; 
			hyp.decay_factor=1.0-1e-11;
		case 'usps3v5'
			hyp.learning_rate=1.0;
			hyp.mini_batch_size=20;
			hyp.sample_size=2000; 
			hyp.decay_factor=1.0-1e-12;
		otherwise
			error('unsupported dataset')
		end
	case 2
		...
		case 'sonar'
			...
			hyp.mini_batch_size=5;
			hyp.sample_size=2000; 
			hyp.decay_factor=0.9;
		case 'ionosphere'
			hyp.learning_rate=0.04;
			hyp.mini_batch_size=5;
			hyp.sample_size=500; 
			hyp.decay_factor=0.9999;
		case 'usps3v5'
			hyp.learning_rate=0.1;
			hyp.learning_rate=5;
			hyp.mini_batch_size=20;
	...
	case 5
		...
		case 'ionosphere'
			hyp.mini_batch_size=5;
			hyp.learning_rate=2.0/n_train;
			hyp.sample_size=500; 
		case 'usps3v5'
			hyp.mini_batch_size=20;
			hyp.learning_rate=2.5/n_train;
			hyp.sample_size=2000; 
		otherwise
			error('unsupported dataset')
		end
	case 6
		...
		hyp.epsilon=1e-8;
		hyp.power=0.0;
		hyp.decay_factor_mean=0.9;
		hyp.decay_factor_var=0.999;
		switch dataset_name
		case 'sonar'
			hyp.mini_batch_size=5;
			hyp.sample_size=2000; 
			hyp.learning_rate=4.0*1e-2;
		case 'ionosphere'
			hyp.mini_batch_size=5;
			hyp.sample_size=500; 
			hyp.learning_rate=25.0*1e-2;
		case 'usps3v5'
			hyp.mini_batch_size=20;
			hyp.sample_size=2000; 
			hyp.learning_rate=2.5;
		otherwise
			error('unsupported dataset')
		end
	otherwise

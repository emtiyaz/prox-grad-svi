...
if nargin<1 
	disp('Usage method_comparison_step_size_prox(dataset_name, output_path, check_idx)');
	return
else
...
for i=1:length(algos) 
	...
	res_name=sprintf('./%s/%s.data.plot-prox-%d.mat',output_path,dataset_name,i);

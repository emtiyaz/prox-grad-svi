...
for k = 1:kmax
  ...
  % GP reg with pseudo_y (we use numerically safe compuatation
  % to compute inv(K+inv(W)) = sW*inv(sW*K*sW + I)*sW,
  % as outlined in Nickisch and Rasmussen (2008), see Section 11
